...
def test_piece_has_position_and_colour(make_dummy_piece: Callable[['Position', 'Colour'], 'DummyPiece']):
    piece = make_dummy_piece(Position(0, 0), Colour.WHITE) 
...
def test_piece_set_position(make_dummy_piece: Callable[['Position', 'Colour'], 'DummyPiece']):
    piece = make_dummy_piece(Position(0, 0), Colour.WHITE) 
    piece.set_position(Position(4, 4))
    assert piece.position == Position(4, 4)
    assert not piece.position == Position(0, 0)
